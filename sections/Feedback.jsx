...
import { fadeIn, staggerContainer,zoom, zoomIn } from "../utils/motion";
const Feedback = () => (
  ...
  variants={staggerContainer}
    ...
    <p className="mt-[8px] font-normal sm:text-[18px] text-[12px] sm:leading-[22px] leading-[16px] text-white">Builder of the page</p>
    </div>
    <p className="mt-[24px] font-normal sm:text-[24px] text-[24px] sm:leading-[45px] leading-[16px] text-white">
    ...
    <img src="/stamp.png"
    alt="stamp"
    className="w-[155px] h-[150] object-contain" />
